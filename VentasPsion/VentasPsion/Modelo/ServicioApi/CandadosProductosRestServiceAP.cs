...
{
    public class CandadosProductosRestServiceAP
    {
        ...
        public StatusRestService FtnCargarCandadosProductosAP(string sConexionUri)
        {
            try
            {
                //string sUri = ConexionService.FtnRegresarUriPrefijoConexion + "CandadosProductosAP";
                string sUri = sConexionUri + "CandadosProductosAP";

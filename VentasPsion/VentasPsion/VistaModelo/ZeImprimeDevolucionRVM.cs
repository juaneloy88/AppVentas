...
{
    public class ZeImprimeDevolucionRVM
    {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        using (SQLiteConnection conn = cODBC.CadenaConexion())
                                        {
                                            ...
                                            {
                                                sFolioAutoventa = " or vdn_folio = '" + sNoTicketParam + "'";
                                                sSql = sSql + sFolioAutoventa;
                                            }
                                            ...
                                            FtnImprimirTexto("Motivo de Devolucion:                           ");
                                            //FtnImprimirTexto(sConceptoDevolParam + (char)29 + "");
                                            FtnImprimirTexto(sConceptoDevolParam.Trim().PadRight(48));
                                            FtnImprimirTexto("------------------------------------------------");
                                            if (VarEntorno.cTipoVenta == 'A' & VarEntorno.bEsDevolucion)
                                            {
                                                FtnImprimirTexto("Ruta: " + iIdRuta.ToString().PadRight(42));
                                                FtnImprimirTexto("Ticket: " + VarEntorno.iFolio.ToString().Trim().PadRight(40));
                                            }
                                            else
                                            {
                                            ...
                                            foreach (var detalleVenta in listaDetallesDevolucion)
                                            {
                                                ...
                                                {
                                                    //FtnImprimirTexto(" ");
                                                    FtnImprimirTexto(String.Format("{0:0}", iCantidad).PadLeft(4) + " " + sDescripcion.ToString().PadRight(43).Substring(0, 43));
                                                    FtnImprimirTexto("------------------------------------------------");
                                                }
                                                else
                                                {
                                                    FtnImprimirTexto(iCantidad.ToString().PadLeft(4) + " " +
                                                                     ...
                                                                     String.Format("{0:0.00}", dPrecio).PadLeft(8) + " " +
                                            ...
                                            if (VarEntorno.cTipoVenta == 'A' )
                                            {
                                                dSaldoFinal = Convert.ToDouble(new fnVentaCabecera().SaldoFinal(oCliente, VarEntorno.iFolio));
                                                importeEnvase = 0;
                                                FtnImprimirTexto("Saldo Anterior........: $ " + String.Format("{0:#,0.00}", dSaldoFinal+ dImporteVenta).PadLeft(15) + "       ");
                                                //FtnImprimirTexto("Total Liquido.........: $ " + String.Format("{0:#,0.00}", (dImporteVenta )).PadLeft(15) + "       ");
                                            ...
                                            {
                                                dSaldoFinal = Convert.ToDouble(new fnVentaCabecera().SaldoFinal(oCliente, Convert.ToInt32(sNoTicket)));

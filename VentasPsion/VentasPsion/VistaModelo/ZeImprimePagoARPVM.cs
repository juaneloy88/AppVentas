...
{
    public class ZeImprimePagoARPVM
    {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        using (SQLiteConnection conn = cODBC.CadenaConexion())
                                        {
                                            ...
                                            //FtnImprimirTexto(" ");
                                            FtnImprimirTexto("------------------------------------------------");
                                            FtnImprimirTexto("Ruta: " + iIdRuta.ToString().Trim().PadRight(42));
                                            ...
                                            FtnImprimirTexto("------------------------------------------------");
                                            FtnImprimirTexto("Cliente: " + (iIdCliente + " - " + sNombreCliente).ToString().PadRight(39).Substring(0, 39));

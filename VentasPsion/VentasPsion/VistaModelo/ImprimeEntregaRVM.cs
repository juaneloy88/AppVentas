...
{
    public class ImprimeEntregaRVM
    {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        using (SQLiteConnection conn = cODBC.CadenaConexion())
                                        {
                                            ...
                                            FtnImprimirTexto("Saldo Actual..........: $ " + String.Format("{0:#,0.00}", (dSaldoFinal - sPagoPreventa)).PadLeft(15));
                                            FtnImprimirTexto("------------------------------------------");
                                            ...
                                            FtnImprimirTexto(" ");
                                            FtnImprimirTexto("------------------------------------------");
                                            FtnImprimirTexto("        DESGLOSE DE PAGO A REPARTO");
